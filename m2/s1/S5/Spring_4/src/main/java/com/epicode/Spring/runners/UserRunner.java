...
public class UserRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User custom = userservice.createCustomUser("Giuseppe", "Verdi", "Napoli", 49, "g.verdi@example.com", "12345678");
		...
		//User p1 = userservice.findUser(1);
		//User p2 = userservice.findUser(2);
		...
		//List<User> listaUserAge = userservice.findUserMax(40);
		//listaUserAge.forEach(u -> System.out.println(u));
