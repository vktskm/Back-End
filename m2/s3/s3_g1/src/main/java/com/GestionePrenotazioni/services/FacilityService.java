...
public class FacilityService {
	...
	public Facility createDefaultFacility(String _name, String _address, String _city, String _secCode) {
		AnnotationConfigApplicationContext appContext = new AnnotationConfigApplicationContext(FacilityConfig.class);
		Facility f = (Facility) appContext.getBean("facility_default", _name, _address, _city, _secCode);
		appContext.close();
		return f;
	}
